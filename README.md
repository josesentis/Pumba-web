...
![logo](http://works.cuchillo.rocks/w11p/screenshot.png)

## 11ty + Wordpress + Cuchillo Core

## Siteground

1. Crear nuevo sitio vacio
2. Entrar las site tools
3. Crear subdominio admin donde se instalara el CMS
4. Barra izquierda: Wordpress -> Migrator y seguir instrucciones.
5. Seguridad -> Gestor SSL -> Seleccionar Let's Encrypt Wildcard
6. Forzar HTTPS
7. Velocidad -> Cloudfare. Conectar la cuenta de cloudfare y activar. Puede estar varios minutos con avisos naranjas.
8. En las pestañas inferiores -> subdominio: Activar el sudominio admin.
